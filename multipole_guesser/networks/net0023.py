...
import pdb
idd = 23
what = "2d conv network. Add a big FC block.  Add capacity. Now it can memorize 100"

def thisnet(Nell):

    model = main_net(Nell, hidden_channels=1024, num_encodings=16)
...
class main_net(nn.Module):
    def __init__(self, Nell, hidden_channels=64, num_encodings=4, fc_layers=[512,1024,512]):
        ...
        pool_h, pool_w = 1, 1   # or whatever you choose
