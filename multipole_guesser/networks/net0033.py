...
idd = 33
what = "3d conv.  L=3 try to leran."

#fname = "clm_take16_L=8.h5"
#fname = "clm_take17_L=3.h5"
fname = "clm_take2_L=3.h5"
#ntrain = 600
ntrain = 20
#ntrain = 600
#nvalid=3
...
def thisnet(Nell):
    ...
    model.register_buffer('train_curve', torch.empty([0]))
    model.register_buffer('val_curve', torch.empty([0]))
    return model
...
def trainer(
    ...
    *,
    ...
    for epoch in range(1, epochs+1):
        ...
        model.train_curve = torch.tensor(train_loss)
        model.val_curve = torch.tensor(val_loss)
