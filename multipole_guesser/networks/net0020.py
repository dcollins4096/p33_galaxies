...
import pdb
idd = 20
what = "2d conv network.  Stop the graph for a moment"

def thisnet(Nell):

    model = main_net(Nell, hidden_channels=512, num_encodings=4)
...
def trainer(
    ...
    *,
    ...
    scheduler = optim.lr_scheduler.MultiStepLR(
        optimizer,
        milestones=[200], #[100,300,600],  # change after N and N+M steps
...
class main_net(nn.Module):
    def __init__(self, Nell, hidden_channels=64, num_encodings=4):
        super().__init__()
